...
def draw_start_screen(screen, title_font, subtitle_font, menu_font, score_font, player_images, ghost_images, counter):
    screen.fill('black')
    ...
    if (pygame.time.get_ticks() // 500) % 2 == 0:
        draw_text('PRESS ENTER OR SPACE', menu_font, config.WHITE, center_x, config.WINDOW_HEIGHT - 195, center=True)
